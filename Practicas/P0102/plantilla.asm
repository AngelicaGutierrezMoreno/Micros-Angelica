...
;-----[ ENCABEZADO ]-----
; Proyecto:	P0102
; Created:	23/08/2019 12:16 p.m.
; Author :	Angélica Gutiérrez Moreno
;******************************************************************************
;	Revisar en:
...
;lo siguiente se corta y pega en todas las aplicaciones

.ORG 0x0000 ; direccion de origen (OBLIGATORIA)
;-----[ VECTORES de ATENCIÓN a INTERRUPCIONES ]-----
	...
	rjmp WDT				; Watchdog Timer Handler-> comprobar el edo de ejecución del programa
	...
	rjmp ADC_RDY			; ADC Conversion Complete Handler (analog-digital converter)
	rjmp EE_RDY				; EEPROM Ready Handler
	rjmp ANA_COMP			; Analog Comparator Handler
	rjmp TWI				; 2-wire Serial Interface Handler
	rjmp SPM_RDY			; Store Program Memory Ready Handler
;------------------------------------------------------------------------------
;-----[ ATENCIÓN a INTERRUPCIONES (si se habilitó su atención)]-----Respuestas
;------------------------------------------------------------------------------
EXT_INT0:
	reti  ;retorno de rutina de interrupción
EXT_INT1:
	reti
PC_INT0:
	reti
...
Aqui_para_Siempre:	;ciclo cerrado->se queda en  caso de que haya una interrupción no planeada
...
RESET:
	...
	out SPH,r16					; Ajuste del Apuntador de Stack al final de RAM...out copia un valor a un registro
	ldi r16, low(RAMEND)		;
	out SPL,r16					;
